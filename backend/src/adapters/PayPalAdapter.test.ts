...
describe("PayPalAdapter", () => {
  describe("parsing a row", () => {
    it("should work with all data", () => {
      const row =
        "15/01/2020;00:12:42;Europe/Berlin;All data test;EUR;-42,5;0;-42,5;-666,66;21D800331X157821M;all.data.test@example.com;All data test receiver;Bank name;Account number;0;0;Invoice number;Transaction code"
    ...
    it("should work with email and no name", () => {
      const row =
        "16/01/2020;01:13:43;Europe/Berlin;No name test;EUR;-69,5;0;-69,5;-666,66;21D800331X157821M;no.name.test@example.com;;Bank name;Account number;0;0;Invoice number;Transaction code"
    ...
    it("should work with name and no email", () => {
      const row =
        "17/01/2020;02:14:44;Europe/Berlin;No email test;EUR;42,5;0;42,5;-666,66;21D800331X157821M;;No email test receiver;Bank name;Account number;0;0;Invoice number;Transaction code"
    ...
    it("should work with no name and no email", () => {
      const row =
        "18/01/2020;03:15:45;Europe/Berlin;No receiver test;EUR;69,5;0;69,5;-666,66;21D800331X157821M;;;Bank name;Account number;0;0;Invoice number;Transaction code"
